...
namespace DAP.Repository
{
    class SQLiteAdapter
    {
        ...
        //teszteléshez egyszerre 850 adat felvitele
        public void insertDirectData()
        {

            myConnection.Open();
            string query = "INSERT INTO ArchivesTable (Company, Category, Content, Date, Description) VALUES " +
                "('asdad', 'Catedfdgory', 'fg', 'ghg', 'fffff')," +
                "('asdad', 'Catedfdgory', 'fg', 'ghg', 'fffff')," +
                "('asdad', 'Catedfdgory', 'fg', 'ghg', 'fffff')," +
                "('asdad', 'Catedfdgory', 'fg', 'ghg', 'fffff')," +
                "('asdad', 'Catedfdgory', 'fg', 'ghg', 'fffff')," +
